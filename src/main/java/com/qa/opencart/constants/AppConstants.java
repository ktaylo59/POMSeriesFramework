...
public class AppConstants {
	...
	//naming convention: capital letters with underscore
	//use final keyword so that values can't be changed
	public static final String LOGIN_PAGE_TITLE = "Account Login";
	public static final String LOGIN_PAGE_URL_FRACTION = "route=account/login";//query parameter
